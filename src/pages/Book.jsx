                            ...
                            <div className="content-container">
                                ...
                                <div className="price">
                                    ...
                                    <div className="price__count">
                                        <button className="price__btn"><span className='price__minus' onClick={() => dispath(decrement())}>-</span></button>
                                        <input type="number" className="price__value" min='1' value={count} required />
                                        <button className="price__btn"><span className='price__plus' onClick={() => dispath(increment())}>+</span></button>
                                    </div>
                                </div>
